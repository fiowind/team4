...
#[test]
fn create_claim_failure_when_claim_exists() {
    new_test_ext().execute_with (|| {
        let claim = vec![0, 1];
...
#[test]
fn create_claim_failure_when_too_long() {
    new_test_ext().execute_with(|| {
...
#[test]
fn revoke_claim_failure_when_not_owner() {
    new_test_ext().execute_with(|| {
        let claim = vec![0, 1];
        let _ = PoeModule::create_claim(Origin::signed(1), claim.clone());
        assert_noop!(
...
#[test]
fn revoke_claim_failure_when_claim_not_exist() {
    new_test_ext().execute_with(|| {
        let claim = vec![0, 1];
        let claim2 = vec![0, 1, 2];
        let _ = PoeModule::create_claim(Origin::signed(1), claim.clone());
        assert_noop!(
...
#[test]
fn transfer_claim_failure_when_not_owner() {
    new_test_ext().execute_with(|| {
        let claim = vec![0, 1];
        let _ = PoeModule::create_claim(Origin::signed(1), claim.clone());
        assert_noop!(
...
#[test]
fn transfer_claim_failure_when_claim_not_exist() {
    new_test_ext().execute_with(|| {
        let claim = vec![0, 1];
        let claim2 = vec![0, 1, 2];
        let _ = PoeModule::create_claim(Origin::signed(1), claim.clone());
